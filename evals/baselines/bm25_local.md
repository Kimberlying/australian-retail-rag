...
- **Config:** `k=4`, `retriever=bm25`, `embedding_model=None`, `chunk_size=900`, `chunk_overlap=120`, `min_score=0.0`, `n_chunks=15`, `model=None`
...
| Refusal accuracy (unanswerable) | 0.182 |
| False refusal rate (answerable) | 0.000 |
| Overall pass rate | 0.818 |
| Latency p50 (ms) | 0.030 |
| Latency p95 (ms) | 0.050 |
...
- **un-007** (unanswerable) — should have refused. Top hit: `synthetic_inventory_replenishment_policy.md`. Q: _How many stores does Harbourline operate in Western Australia?_
