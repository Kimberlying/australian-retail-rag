...
- **Created:** 2026-09-25T03:40:17+00:00
- **Git SHA:** `cc85b3b` · **version:** 0.3.0
- **Generation mode:** local
- **Config:** `k=4`, `retriever=dense`, `embedding_model=BAAI/bge-small-en-v1.5`, `chunk_size=900`, `chunk_overlap=120`, `min_score=0.52`, `n_chunks=15`, `model=None`
...
| Overall pass rate | 0.818 |
| Latency p50 (ms) | 2.880 |
| Latency p95 (ms) | 4.580 |

## By category

| Category | n_examples | hit_rate | recall | mrr | refusal_accuracy | pass_rate |
|---|---|---|---|---|---|---|
| multi_doc | 4 | 1.000 | 1.000 | 0.875 | - | 1.000 |
| paraphrase | 9 | 0.889 | 0.889 | 0.732 | - | 0.889 |
| public_fact | 7 | 1.000 | 1.000 | 1.000 | - | 1.000 |
| synthetic_policy | 24 | 0.958 | 0.958 | 0.910 | - | 0.958 |
...
- Answerable: min 0.563, median 0.771
...
- **para-006** (paraphrase) — relevant evidence not retrieved. Top hit: `synthetic_store_operations_handbook.md`. Q: _A biscuit contains peanuts that are not on the label. How urgently must it come off the shelves?_
...
- **un-004** (unanswerable) — should have refused. Top hit: `synthetic_loyalty_program_terms.md`. Q: _What is Harbourline Retail's annual revenue?_
...
- **un-008** (unanswerable) — should have refused. Top hit: `coles_fy25_public_snapshot.md`. Q: _What is the current Reserve Bank of Australia cash rate?_
